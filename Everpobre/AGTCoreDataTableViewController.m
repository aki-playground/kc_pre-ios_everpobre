...
-(void) motionEnded:(UIEventSubtype)motion withEvent:(UIEvent *)event{
    if(motion == UIEventSubtypeMotionShake){
        //Se ha producido un shake
        
        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"Undo/Redo"
                                                                                 message:@"Undo-Redo"
                                                                          preferredStyle:UIAlertControllerStyleAlert];
        //We add buttons to the alert controller by creating UIAlertActions:
        if ([self.fetchedResultsController.managedObjectContext.undoManager canRedo]){
        
            UIAlertAction *actionRedo = [UIAlertAction actionWithTitle:@"Redo"
        ...
        if ([self.fetchedResultsController.managedObjectContext.undoManager canUndo]){
            UIAlertAction *actionUndo = [UIAlertAction actionWithTitle:@"Undo"
                                                                 style:UIAlertActionStyleDefault
                                                               handler:^(UIAlertAction * _Nonnull action) {
